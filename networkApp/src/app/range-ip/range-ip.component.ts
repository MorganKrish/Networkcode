...
@Component({
  selector: 'app-range-ip',
  templateUrl: './range-ip.component.html',
  styleUrls: ['./range-ip.component.css']
})
export class RangeIpComponent implements OnInit {
  dat1:any="";
  dat2:any="";
  colDef1:any=[];
  rowDt:any=[];
  ...
  showTab()
  {
    var js:any=
    {
    ip_address:this.dat1,
    ip_address_endRange:this.dat2
    }
